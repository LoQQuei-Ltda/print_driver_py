...
def build_windows_installer():
    ...
    try:
        ...
        installer_path = "Output/Instalador_Gerenciamento_LoQQuei_V2.0.3.exe"
...
'''
        ...
        dmg_path = os.path.join(output_dir, "LoQQuei_PrintManagement_V2.0.3.dmg")
...
'''
        ...
        deb_path = os.path.join(output_dir, "loqquei-printmanagement_2.0.3_amd64.deb")
...
'''
        ...
        appimage_path = os.path.join(output_dir, "LoQQuei_PrintManagement-2.0.3-x86_64.AppImage")
